              ...
              <CardContent className="p-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="relative h-80 lg:h-96">
                    ...
                    >
                      <source src="https://streamable.com/e/4kpt7j?" type="video/mp4" />
              ...
              <CardContent className="p-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="relative h-80 lg:h-96 order-2 lg:order-1">
                    ...
                    >
                      <source src="https://streamable.com/e/aciubw?" type="video/mp4" />
            ...
            <Card className="group border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden bg-white">
              <CardContent className="p-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="relative h-80 lg:h-96">
                    <img 
                      src="https://i.ibb.co/m16SHYv/homepage.png"
            ...
            <Card className="group border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden bg-white">
              <CardContent className="p-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="relative h-80 lg:h-96 order-2 lg:order-1">
                    <img 
                      src="https://i.ibb.co/6JgJLvJ7/leaderboard.png" 
