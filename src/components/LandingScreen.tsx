      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="text-5xl font-bold text-gray-900">SAT AI Prep</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Master the SAT with our AI-powered test preparation platform. Get personalized practice questions, 
            comprehensive mock tests, and intelligent feedback to achieve your target score.
          </p>
        </div>
        ...
        <Button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-12 py-4 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
        >
          Get Started
        </Button>
