  ...
  const performanceData = useMemo(() => {
    if (!questionAttempts || questionAttempts.length === 0) {
      return {
        ...
        domainData: RealTimePerformanceService.getDefaultReadingWritingDomains(),
        subdomainData: [],
        overallAccuracy: 0
      };
    }
    ...
    const domainData = RealTimePerformanceService.calculateReadingWritingDomains(questionAttempts as any);
    const subdomainData = RealTimePerformanceService.calculateReadingWritingSubdomains(questionAttempts as any);
...
export default QuestionTopicsDifficulty;